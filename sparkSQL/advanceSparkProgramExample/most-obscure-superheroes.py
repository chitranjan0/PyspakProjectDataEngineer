...
names = spark.read.schema(schema).option("sep", " ").csv("/Users/chitranjan.kumar/Desktop/PyspakProjectDataEngineer/sparkSQL/sparkSQLDataFile/Marvel+Names")

lines = spark.read.text("/Users/chitranjan.kumar/Desktop/PyspakProjectDataEngineer/sparkSQL/sparkSQLDataFile/Marvel+Graph")
